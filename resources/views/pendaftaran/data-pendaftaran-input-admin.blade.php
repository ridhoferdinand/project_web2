                ...
                <div class="custom-accordion">
                            ...
                            <div class="p-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        ...
                                        <p class="text-muted text-truncate mb-0">NPM, NIK, Nama, Jenis Kelamin, Pas
                                            Photo, TTL, dsb</p>
                                    </div>
                        ...
                        <div id="personal-data" class="collapse show">
                            <div class="p-4 border-top">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3 mb-4">
                                            <label class="form-label" for="personal-data-nisn">NPM</label>
                                            <input type="text" class="form-control" id="personal-data-nisn"
                                                name="nisn" placeholder="Masukkan NPM" value="{{ old('nisn') }}" required>
                                            @error('nisn')
                    ...
                    <div class="card">
                            ...
                            <div class="p-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        ...
                                        <p class="text-muted text-truncate mb-0">Pilihan divisi himpunan </p>
                                    </div>
                                    <div class="flex-shrink-0"> <i
                                            class="mdi mdi-chevron-up accor-down-icon font-size-24"></i> </div>
                                </div>
                        ...
                        <div id="registration-data" class="collapse">
                            <div class="p-4 border-top">
                                <div class="mb-4">
                                    <label class="form-label" for="billing-address">Wawancara</label>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input class="form-control" list="datalistOptionsProdi" id="exampleDataList"
                                                placeholder="Pilih divisi himpunan" name="pil1"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input class="form-control" list="datalistOptionsProdi" id="exampleDataList"
                                                placeholder="Pilih divisi himpunan" name="pil2"
