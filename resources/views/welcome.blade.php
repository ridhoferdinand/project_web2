...
<head>
    ...
    <meta name="description" content="HIMA INFORMATIKA">
    <meta property="og:title" content="HIMA INFORMATIKA">
    <meta property="og:description" content="HIMA INFORMATIKA">

    <!-- PAGE TITLE HERE -->
    <title>Masuk dan Daftar | HIMA INFORMATIKA</title>
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                <div class="content">
                    <h3>Baru disini ?</h3>
                    <p>
                        Silahkan daftar akun untuk melanjutkan proses pendaftaran HIMA INFORMATIKA!
                    </p>
                    <button class="btn transparent" id="sign-up-btn">
                        DAFTAR
                    </button>
                </div>
                <img src="{{ asset('sipenmaru/images/logo.png') }}" class="image" alt="" />
            </div>
            <div class="panel right-panel">
                <div class="content">
                    <h3>Salah satu diantara kami ?</h3>
                    <p>
                        Silahkan masuk jika anda telah memiliki akun pendaftaran HIMA INFORMATIKA.
                    </p>
